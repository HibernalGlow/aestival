...
{#if $settingsOverlayOpen}
	...
	>
		...
		<div
			class="relative flex h-[80vh] w-[80vw] max-w-5xl flex-col overflow-hidden rounded-xl border bg-background/95 text-foreground shadow-2xl backdrop-blur-md"
		>
			<!-- 标题栏 -->
			<div
				class="flex h-10 shrink-0 items-center justify-between border-b bg-secondary/50 px-4"
			>
